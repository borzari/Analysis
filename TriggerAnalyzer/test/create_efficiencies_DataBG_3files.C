...
void create_efficiencies_DataBG_3files()
{
    setTDRStyle();
    ...
    writeExtraText = true;
    extraText = "";
    lumi_sqrtS = "61.8 fb^{-1} (13.6 TeV)";
    // lumi_sqrtS = "(13.6 TeV)";

    std::string inputFile1 = "plots/log_right_Muon_2022.root";
    std::string inputFile2 = "plots/log_right_Muon_2023.root";
    std::string inputFile3 = "plots/log_right_WToLNu_.root";
    ...
    std::string legend_file2 = "2023 data";
    std::string legend_file3 = "W #rightarrow l#nu MC";
    ...
    MET105_file1->GetXaxis()->SetMoreLogLabels();
    // MET105_file1->GetXaxis()->SetNoExponent();

    MET105_file2->SetMarkerColor(4);
    MET105_file2->SetLineColor(4);
    MET105_file2->SetMarkerStyle(20);
    
    MET105_file3->SetMarkerColor(2);
    MET105_file3->SetLineColor(2);
    MET105_file3->SetMarkerStyle(20);
    ...
    legend1->AddEntry(MET105_file3, legend_file3.c_str(), "P");
    ...
    MET105_file3->Draw("P,SAME");
    legend1->Draw();
    l->Draw();
    CMS_lumi(c1, 0, 0);
    c1->Update();
    c1->Write();
    std::string c1Name = "plots/EXOLLPTriggerPaper/logPlots/moreLog_2022vs2023vMC_HLT_MET105_IsoTrk50_v.pdf";
    ...
    filterMET105_file1->GetXaxis()->SetMoreLogLabels();
    // filterMET105_file1->GetXaxis()->SetNoExponent();

    filterMET105_file2->SetMarkerColor(4);
    filterMET105_file2->SetLineColor(4);
    filterMET105_file2->SetMarkerStyle(20);
    
    filterMET105_file3->SetMarkerColor(2);
    filterMET105_file3->SetLineColor(2);
    filterMET105_file3->SetMarkerStyle(20);

    // legend1->SetHeader("hltMET105");
    filterMET105_file1->Draw("AP");
    filterMET105_file2->Draw("P,SAME");
    filterMET105_file3->Draw("P,SAME");
    legend1->Draw();
    l->Draw();
    CMS_lumi(c2, 0, 0);
    c2->Update();
    c2->Write();
    std::string c2Name = "plots/EXOLLPTriggerPaper/logPlots/moreLog_2022vs2023vMC_filterMET105.pdf";
    ...
    GrandOR_file1->GetXaxis()->SetMoreLogLabels();
    // GrandOR_file1->GetXaxis()->SetNoExponent();

    GrandOR_file2->SetMarkerColor(4);
    GrandOR_file2->SetLineColor(4);
    GrandOR_file2->SetMarkerStyle(20);
    
    GrandOR_file3->SetMarkerColor(2);
    GrandOR_file3->SetLineColor(2);
    GrandOR_file3->SetMarkerStyle(20);

    // legend1->SetHeader("OR of Signal Paths");
    GrandOR_file1->Draw("AP");
    GrandOR_file2->Draw("P,SAME");
    GrandOR_file3->Draw("P,SAME");
    legend1->Draw();
    l->Draw();
    CMS_lumi(c3, 0, 0);
    c3->Update();
    c3->Write();
    std::string c3Name = "plots/EXOLLPTriggerPaper/logPlots/moreLog_2022vs2023vMC_GrandOR.pdf";
    ...
    filterTrk50_file1->GetXaxis()->SetTitleOffset(1.25);
    ...
    filterTrk50_file1->GetXaxis()->SetMoreLogLabels();
    // filterTrk50_file1->GetXaxis()->SetNoExponent();

    filterTrk50_file2->SetMarkerColor(4);
    filterTrk50_file2->SetLineColor(4);
    filterTrk50_file2->SetMarkerStyle(20);
    
    filterTrk50_file3->SetMarkerColor(2);
    filterTrk50_file3->SetLineColor(2);
    filterTrk50_file3->SetMarkerStyle(20);

    // legend1->SetHeader("HLT_MET105_IsoTrk50_v*, hltMET105 applied");
    filterTrk50_file1->Draw("AP");
    filterTrk50_file2->Draw("P,SAME");
    filterTrk50_file3->Draw("P,SAME");
    legend1->Draw();
    l->Draw();
    CMS_lumi(c4, 0, 0);
    c4->Update();
    c4->Write();
    std::string c4Name = "plots/EXOLLPTriggerPaper/logPlots/moreLog_2022vs2023vMC_filterIsoTrk50.pdf";
    ...
    // c5->Update();
    // c5->Write();
    // std::string c5Name = "plots/EXOLLPTriggerPaper/logPlots/2022_filterMET105.pdf";
    ...
    // c6->Update();
    // c6->Write();
    // std::string c6Name = "plots/EXOLLPTriggerPaper/logPlots/2023_filterMET105.pdf";
    ...
    // c7->Update();
    // c7->Write();
    // std::string c7Name = "plots/EXOLLPTriggerPaper/logPlots/2022_filterIsoTrk50.pdf";
    ...
    // c8->Update();
    // c8->Write();
    // std::string c8Name = "plots/EXOLLPTriggerPaper/logPlots/2023_filterIsoTrk50.pdf";
