...
from Analysis.StdAna.candTrkSel_cfi import *
...
process = cms.Process ('CANDTRKSEL', Run3)
...
process.TFileService = cms.Service ('TFileService',
    fileName = cms.string ('candTrkSel_outputHistograms.root')
)
...
process.candTrkSelFilter = candTrkSelFilter_.clone()

if isCRAB:
    process.candTrkSelFilter.isCRAB = True

if useMETTriggers:
    process.candTrkSelFilter.isMETTriggers = True

process.filterPath = cms.Path(process.candTrkSelFilter)
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:candTrkSel_selected.root'),
