...
from Analysis.StdAna.basicSel_cfi import *
...
process = cms.Process ('BASICSEL', Run3)
...
process.TFileService = cms.Service ('TFileService',
    fileName = cms.string ('basicSel_outputHistograms.root')
)
...
process.basicSelFilter = basicSelFilter_.clone()

if isCRAB:
    process.basicSelFilter.isCRAB = True

if useMETTriggers:
    process.basicSelFilter.isMETTriggers = True

process.filterPath = cms.Path(process.basicSelFilter)
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:basicSel_selected.root'),
